...
function renderStickerEditor(){
  ...
  body+=`<div class="two-col"><label>Largura <strong id="stickerWidthValue">${Math.round(s.width||100)}%</strong><input id="stickerWidth" type="range" min="12" max="180" step="1" value="${s.width||100}"></label><label>Altura <strong id="stickerHeightValue">${Math.round(s.height||100)}%</strong><input id="stickerHeight" type="range" min="10" max="180" step="1" value="${s.height||100}"></label></div><small>Agora largura e altura são independentes. Arraste o sticker diretamente sobre a imagem para posicionar.</small>`;
  box.innerHTML=body;
