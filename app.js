...
function renderStickerEditor(){
  ...
  body+=`<div class="two-col"><label>Largura <strong id="stickerWidthValue">${Math.round(s.width||100)}%</strong><input id="stickerWidth" type="range" min="12" max="180" step="1" value="${s.width||100}"></label><label>Altura <strong id="stickerHeightValue">${Math.round(s.height||100)}%</strong><input id="stickerHeight" type="range" min="10" max="180" step="1" value="${s.height||100}"></label></div><div class="appearance-title">Aparência</div><div class="appearance-grid"><label>Fundo<input id="stickerBg" type="color" value="${s.bgColor||'#ffffff'}"></label><label>Texto<input id="stickerColor" type="color" value="${s.textColor||'#111111'}"></label><label>Cantos <strong id="stickerRadiusValue">${Math.round(s.radius??16)}px</strong><input id="stickerRadius" type="range" min="0" max="40" step="1" value="${s.radius??16}"></label><label>Texto <strong id="stickerFontValue">${Math.round(s.fontSize??14)}px</strong><input id="stickerFont" type="range" min="8" max="32" step="1" value="${s.fontSize??14}"></label><label>Opacidade <strong id="stickerOpacityValue">${Math.round(s.opacity??100)}%</strong><input id="stickerOpacity" type="range" min="20" max="100" step="1" value="${s.opacity??100}"></label></div><div class="style-presets"><button type="button" data-style="light">Branco</button><button type="button" data-style="dark">Preto</button><button type="button" data-style="gradient">Gradiente</button><button type="button" data-style="clear">Transparente</button></div><small>Largura, altura e aparência são independentes. Arraste o sticker diretamente sobre a imagem para posicionar.</small>`;
  box.innerHTML=body;
